...
export class GatewayController {
    ...
    async GetAllFileList() {
        let message = [""]
        await this.SendMessage("GetAllFileList", message)
    }
    async GetRecordList() {
        let message = [""];
    ...
    async GetDictList() {
        let message = [""];
        await this.SendMessage("GetDictList", message);
    }
    async ReadDictionary(recordId: string) {
        let message = [recordId];
        await this.SendMessage("ReadDictionary", message);
    ...
    async OpenDictionary(fileName: string) {
        let message = [fileName];
        await this.SendMessage("OpenDictionary", message);
    }
