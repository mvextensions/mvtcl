...
export class NetFile {
    ...
    public async OpenDictionary()
    {
        let message = [this.FileName,this.NetFileLockStrategy.toString(),this.NetFileReleaseStrategy.toString()];
        await this.messageController.SendMessage(MessageType.OpenDictionary, message);
        this.FileIsOpen = true;
        this.FileName = "DICT."+this.FileName;
    }
